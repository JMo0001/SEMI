...
COMMENT ON COLUMN "TBL_RESULT"."MNO" IS '후보 번호';
COMMENT ON COLUMN "TBL_RESULT"."MCOUNT" IS '득표수';
...
ALTER TABLE "TBL_RESULT" ADD CONSTRAINT "PK_TBL_RESULT" PRIMARY KEY (
	"MNO"
);
...
ALTER TABLE "TBL_RESULT" ADD CONSTRAINT "FK_TBL_MEMBER_TO_TBL_RESULT_1" FOREIGN KEY (
	"MNO"
)
REFERENCES "TBL_MEMBER" (
	"MNO"
